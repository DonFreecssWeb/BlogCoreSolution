...
namespace BlogCore.Areas.Identity.Pages.Account
{
    ...
    {
        //Cambiar IdentityUser por mi clase custom que además de tener las propieades de la clase padre
        //tiene propiedades custom como nombre,ciudad,país, etc
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //para solucionar el error:NotSupportedException: No IUserTwoFactorTokenProvider<TUser> named 'Default' is registered.
